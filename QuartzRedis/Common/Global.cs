...
namespace QuartzRedis.Common
{
    public class Global
    {
...
#endif
        public const string GROUP = "GIFT-ZHUAE-POINT";

        public const string TASK_JOB = "GIFT-ZHUAE-POINT";
        ...
        public static string ZEDBUrl
        {
            get
            {
                return Environment.GetEnvironmentVariable("ZEDBUrl");
            }
        }

        public static string ZEDBUser
        {
            get
            {
                return Environment.GetEnvironmentVariable("ZEDBUser");
            }
        }

        public static string ZEDBPort
        {
            get
            {
                return Environment.GetEnvironmentVariable("ZEDBPort");
            }
        }

        public static string ZEDBPassword
        {
            get
            {
                return Environment.GetEnvironmentVariable("ZEDBPassword");
            }
        }
